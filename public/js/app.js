...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\laragon\\www\\new\\node_modules\\axios\\index.js'");
...
/*!*******************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/postcss-loader/src??ref--5-2!./node_modules/element-ui/lib/theme-chalk/index.css ***!
  \*******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nError: ENOENT: no such file or directory, open 'D:\\laragon\\www\\new\\node_modules\\element-ui\\lib\\theme-chalk\\index.css'");
...
/***/ "./node_modules/element-ui/lib/locale/lang/ar.js":
/*!*******************************************************!*\
  !*** ./node_modules/element-ui/lib/locale/lang/ar.js ***!
  \*******************************************************/
/*! no static exports found */
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\laragon\\www\\new\\node_modules\\element-ui\\lib\\locale\\lang\\ar.js'");
...
var content = __webpack_require__(/*! !../../../css-loader??ref--5-1!../../../postcss-loader/src??ref--5-2!./index.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/element-ui/lib/theme-chalk/index.css");
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\laragon\\www\\new\\node_modules\\vue-table-component\\dist\\index.js'");
...
/* harmony import */ var element_ui_lib_locale_lang_ar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! element-ui/lib/locale/lang/ar */ "./node_modules/element-ui/lib/locale/lang/ar.js");
/* harmony import */ var element_ui_lib_locale_lang_ar__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(element_ui_lib_locale_lang_ar__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var vue_table_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue-table-component */ "./node_modules/vue-table-component/dist/index.js");
/* harmony import */ var vue_table_component__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(vue_table_component__WEBPACK_IMPORTED_MODULE_4__);
/**
...
Vue.use(element_ui__WEBPACK_IMPORTED_MODULE_1___default.a, {
  locale: element_ui_lib_locale_lang_ar__WEBPACK_IMPORTED_MODULE_2___default.a
});
Vue.mixin(_mixins__WEBPACK_IMPORTED_MODULE_0__["default"]);

Vue.use(vue_table_component__WEBPACK_IMPORTED_MODULE_4___default.a, {
...
__webpack_require__(/*! ./components/dashboard/users/index */ "./resources/js/components/dashboard/users/index.js");
__webpack_require__(/*! ./components/dashboard/users/form */ "./resources/js/components/dashboard/users/form.js");
var app = new Vue({
  el: '#app'
});
...
/***/ "./resources/js/components/dashboard/users/form.js":
/*!*********************************************************!*\
  !*** ./resources/js/components/dashboard/users/form.js ***!
  \*********************************************************/
/*! no static exports found */
...
Vue.component('admins-form', {
  ...
  methods: {
    save: function save() {
      var url = this.user ? "/dashboard/users/".concat(this.user.id) : '/dashboard/users';
      var method = this.user ? 'PUT' : 'POST';
...
/***/ "./resources/js/components/dashboard/users/index.js":
/*!**********************************************************!*\
  !*** ./resources/js/components/dashboard/users/index.js ***!
  \**********************************************************/
/*! no static exports found */
...
Vue.component('admins-index', {
  ...
  mounted: function mounted() {
    var _this = this;
    this.$on('userDeleted', function (id) {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios.get('/dashboard/users/data', {
                params: {
                  page: page,
                  filter: filter,
                  sort: sort
    ...
    whenFormSuccess: function whenFormSuccess(response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deleteItem: function deleteItem(id, url) {
      var _this = this;
    ...
    saveForm: function saveForm(url, method) {
      var _this2 = this;
      ...
      axios({
        ...
        _this2.hideLoading();
        _this2.$emit('formSaved', response.data);
        if (_this2.SWALSuccess) {
          _this2.notify_success(response.data.message);
        }
        setTimeout(function () {
          if (redirect !== null) {
            window.location.href = BASE_URL + redirect;
          } else {
            _this2.requestForm.disabled = false;
          }
        }, 2000);
        _this2.requestForm.validations = [];
        _this2.disabledButtons = false;
        _this2.whenFormSuccess(response); // new
    ...
    whenFormSuccess: function whenFormSuccess() {
      var response = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    },
    convertCustomErrorObjectForSwalToString: function convertCustomErrorObjectForSwalToString(response) {
      var returned_string = '';
      if (response.message != undefined && response.errors != undefined)
        // custom error from helpers
        {
          if (response.errors instanceof Object) {
            ...
            // response is single text message
            returned_string = response.message ? response.message : response.error_message + "<br>";
          }
        } else if (response.error.data.error_message != undefined)
        // custom error from helpers
        {
    ...
    getDiffForHuman: function getDiffForHuman(date) {
    ...
    notify_error: function notify_error(message) {
    ...
    notify_success: function notify_success(message) {
    ...
    deleteObject: function deleteObject(url) {
      var _this3 = this;
      ...
      swal.fire({
        ...
        if (result.value) {
          ...
          axios["delete"](url).then(function (response) {
            ...
            swal.fire(__('Deleted Successfully'), '', 'success');
          })["catch"](function (error) {
            _this3.hideLoading();
            console.log(error);
            swalError(error);
