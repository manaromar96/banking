    ...
    @else
        ...
        <head><base href="">
            ...
            @if(app()->getLocale() == 'en')
                ...
                <link href="{{url('')}}/assets/css/custom-en.css" rel="stylesheet" type="text/css" />
            @else
                ...
                <link href="{{url('')}}/assets/css/custom-ar.css" rel="stylesheet" type="text/css" />
            @endif
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <!--begin::Logo-->
            <a href="index.html">
                {{-- <img alt="Logo" src="{{asset('/assets/media/logos/lmtna.jpg')}}"/> --}}
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper" >
                    ...
                    <div id="kt_header" class="header header-fixed">
                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <!--begin::Topbar-->
                            <div class="topbar">
                                <div class="topbar-item" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="topbar-item">
                                    @if(app()->isLocale('ar'))
                                        <a href="{{ route('change_language', ['lang' => 'en']) }}" >
                                        <span class="m-nav__link-icon">
                                            <span class="m-nav__link-icon-wrapper"><img src="{{asset('assets/en.png')}}"> En </span>
                                        </span>
                                        </a>
                                    @else
                                        <a href="{{ route('change_language', ['lang' => 'ar']) }}" >
                                        <span class="m-nav__link-icon">
                                            <span class="m-nav__link-icon-wrapper"><img src="{{asset('assets/ar.png')}}"> ع </span>
                                        </span>
                                        </a>
                                    @endif
                                </div>
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <!--end::Header-->
            <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 238px; overflow: hidden;">
                <!--begin::Header-->
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" style="background-image:url('{{asset('assets/media/svg/avatars/009-boy-4.svg')}}')"></div>
                        <i class="symbol-badge bg-success"></i>
                    </div>
                    <div class="d-flex flex-column">
                        {{--                <span  class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->guard('web')->user()->name}}</span>--}}
                        <div class="navi mt-2">
...
{{--                            <span class="navi-text text-muted text-hover-primary">{{auth()->guard('web')->user()->mobile}}</span>--}}
                        </span>
                    </span>
                ...
                <!--end::Notifications-->
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 238px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 63px;"></div></div></div>
            <!--begin::Content-->
            ...
            <div class="offcanvas-content">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="d-flex align-items-center justify-content-between py-8">
                        ...
                        <a href="#" class="symbol symbol-70 flex-shrink-0">
                            <img src="{{url('')}}/assets/media/stock-600x400/img-4.jpg" title="" alt="" />
                        </a>
                    </div>
                    <!--end::Item-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center justify-content-between py-8">
                        ...
                        <a href="#" class="symbol symbol-70 flex-shrink-0">
                            <img src="{{url('')}}/assets/media/stock-600x400/img-8.jpg" title="" alt="" />
                        </a>
                    </div>
                    <!--end::Item-->
                </div>
                    ...
                    <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                        ...
                        <div class="mb-15">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-5">
                                <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{url('')}}/assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" />
									</span>
                                </div>
                                <div class="d-flex flex-column flex-grow-1 mr-2">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-5">
                                <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{url('')}}/assets/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt="" />
									</span>
                                </div>
                                <div class="d-flex flex-column flex-grow-1 mr-2">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-5">
                                <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{url('')}}/assets/media/svg/misc/005-bebo.svg" class="h-50 align-self-center" alt="" />
									</span>
                                </div>
                                <div class="d-flex flex-column flex-grow-1 mr-2">
        ...
        <div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-content">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{url('')}}/assets/media/demos/demo8.png" alt="" class="w-100" />
                        </div>
                        <div class="overlay-layer">
